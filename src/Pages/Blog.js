    ...
    <div>
      ...
      <div className='containerr-fluid pt-5 contact-bg'>
        ...
        <div className='container mb-5 pb-5 text-center'>
          ...
          <h3 className='blog-para'>Join our talent network of the world’s best talent to experience full-time, long-term remote work with effective compensation and career growth opportunities.</h3>
          <div className='blog-search justify-content-center mt-3 d-flex'>
            ...
            <select className='blog-search'>
              <option disabled aria-hidden="true">ALL Category</option>
