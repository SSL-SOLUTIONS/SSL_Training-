        ...
        <div>
                            ...
                            <div className='col-lg-4 col-md-6'>
                                <div className='py-5 bg-light shadow-md p-3 mb-5 bg-white rounded card mb-5 w-100 text-center'>
                                    ...
                                    <div className='card-body py-3'>
                                        ...
                                        <p className=''>
                                            Quickly and easily set achievable goals
            ...
            <div className='container-fluid mb-5 about-1-bg'>
                <div className='text-light container bg-set'>
                    <div className='row text-center'>
                        ...
                        <div className='col-lg-3 col-md-6'>
                            <h1>
                                <CountUp duration={2} className="counter text-light" end={600} />
                            </h1>
                            <h5>Happy Clients</h5>
                        </div>
                    </div>
            ...
            <div className='container mb-5 pb-5 info-bg bg-light'>
                <div className='container info'>
                    <h1 className='black pt-5 my-font'>About the Product</h1>
                    <h4>
                    ...
                    <div className='about-info pt-5'>
                        <h1 className='black my-font'>Information Collection</h1>
                        <h4>
                            It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using ‘Content here, content here’, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy.
                        </h4>
                    </div>
                ...
                <div className='container about-info-image mt-5 mb-5'>
                    <img src='https://testrabbit.co/wp-content/uploads/2023/06/Image.jpg' className='w-100'></img>
                </div>
                <div className='container info-heading'>
                    <h1 className='my-font black'>Non-Identifiable or Aggregated Data</h1>
                    <p>
                        It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using ‘Content here, content here’, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy.
                    </p>
                    <p>
                    ...
                    <p>
                        You may address any questions or concerns about letsremotify Privacy Policy or data handling policies of this Service to support@letsremotify.com by email or letter, as follows:
                    </p>
                    <br></br>
            ...
            <div className='container text-center companies pb-5 pt-5'>
                ...
                <div className='companies-img mt-5'>
                    <img className='w-75' src='https://testrabbit.co/wp-content/uploads/2023/06/Logos.jpg'></img>
                </div>
            </div>
                    ...
                    <div className='col-lg-4'>
                        <div className='p-2 bg-light rounded-card inte-card mb-5'>
                            <div className='container about-card-img d-flex'>
                                ...
                                <h2 className='mt-3 mx-2'><span className='social-heading'>FaceBook</span> <br></br> <span className='text-muted social'>Social</span></h2>
                            </div>
                            <div className='card-body'>
                                ...
                                <p className=''>
                                    ...
                                    Quisque diam dui, imperdiet <br /><br />
                    ...
                    <div className='col-lg-4'>
                        <div className='p-2 bg-light rounded-card inte-card mb-5'>
                            <div className='container about-card-img d-flex'>
                                ...
                                <h2 className='mt-3 mx-2'><span className='social-heading'>Twitter</span><br></br> <span className='text-muted social'>Social</span></h2>
                            </div>
                            <div className='card-body'>
                                <h3 className='black'>Easy Goal Setting</h3>
                                <p className=''>
                    ...
                    <div className='col-lg-4'>
                        <div className='p-2 bg-light rounded-card inte-card mb-5'>
                            <div className='container about-card-img d-flex'>
                                ...
                                <h2 className='mt-3 mx-2'><span className='social-heading'>Youtube</span> <br></br> <span className='text-muted social'>Social</span></h2>
                            </div>
                            <div className='card-body'>
                                <h3 className='black'>Easy Goal Setting</h3>
                                <p className=''>
