            ...
            <div className='container'>
                    ...
                    <div className='main-section pb-5'>
                        ...
                        <div className='container mt-5'>
                            ...
                            <a href='' className='text-decoration-none font-italic text-muted'>Learn More</a> <i class="fa-solid fa-arrow-right"></i>
                        </div>
                ...
                <div className='main-section pb-5'>
                    <div className='container mt-5'>
                        <h4 className='font-weight-lighter'>Treat Candidates with Creative Assessments</h4>
                        <a href='' className='text-decoration-none font-italic text-muted'>Learn More</a> <i class="fa-solid fa-arrow-right"></i>
                        <div className='container text-center test-img-1'>
                ...
                <div className='main-section pb-5'>
                    <div className='container mt-5'>
                        <h4 className='font-weight-lighter'>Choose the skilled candidates for hire</h4>
                        <a href='' className='text-decoration-none font-italic text-muted'>Learn More</a> <i class="fa-solid fa-arrow-right"></i>
                    </div>
                    <div className='container text-center test-img-1'>
                ...
                <div className='main-section pb-5 pb-5'>
                    <div className='container mt-5'>
                        <h4 className='font-weight-lighter'>Code collectively before working together. Evaluate candidates to collaborate and communicate</h4>
                        <a href='' className='text-decoration-none font-italic text-muted'>Learn More</a> <i class="fa-solid fa-arrow-right"></i>
                    </div>
