    ...
    return (
      <div>
        ...
        <div className="container pt-5">
          <h6 className="mt-5 pt-5 black text-center ">
          ...
          <div className="row">
            <div className="col-lg-4 tab">
              <div className="content border rounded text-center">
                ...
                <p className="m-4">
                  It’s essential to hire as soon as possible. As a result, use
                  our text-powered solutions to keep your prospects informed.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 tab">
              <div className="content border rounded text-center">
                ...
                <p className="m-4">
                  Screen your applicants and extract real-time scores in order
                  to reveal the strongest candidates for the technical
            ...
            <div className="col-lg-4 tab">
              <div className="content border rounded text-center">
                ...
                <p className="m-4">
                  ...
                  right fit by recreating how you’d collaborate to accomplish
                  it.
                </p>
              </div>
            </div>
          ...
          <div className="row mt-1">
            ...
            <div className="col-lg-4 tab">
              <div className="content border rounded text-center">
                ...
                <p className="m-4">
                  By providing a link to a test or take-home project at
                  colleges, you may broaden your recruiting pool with new
                  talent.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 tab">
              <div className="content border mb-5 rounded text-center">
                ...
                <p className="m-4">
                  You need a learning solution that lets your teams operate
                  faster than their competitors while also maintaining high
                  standards.
                </p>
              </div>
            </div>
